...
pub use mutate::{
    ...
    set_share_policy, set_status, set_visibility, slot_holder, slots_in, supersedes, synthesise,
    unlink, update_hypothesis_status, upsert_edge, upsert_node, write_episode,
